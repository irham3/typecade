            ...
            <motion.div layout className="hidden lg:flex items-center justify-center gap-2 mb-10 overflow-x-auto px-2 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] w-full z-10 relative">
                ...
                <AnimatePresence mode="popLayout">
                    ...
                    >
                        ...
                        <Button
                            variant="ghost"
                            className="flex items-center justify-center p-2 shrink-0 hover:text-accent hover:bg-accent/10 rounded-xl"
                            onClick={() => setIsSettingsModalOpen(true)}
                        >
                            <Settings size={16} className="opacity-70 transition-transform duration-300 hover:rotate-90" />
                        </Button>
                    </motion.div>
                </AnimatePresence>
            </motion.div>
                    ...
                    <div className="fixed inset-0 z-9999 flex items-center justify-center p-4">
                        ...
                        >
                            ...
                            <div className="space-y-6 sm:space-y-8 relative z-10">
                                ...
                                {/* Sound Settings */}
                                <div className="space-y-4 pt-6 sm:pt-4 border-t border-foreground/5">
