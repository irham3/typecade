                    ...
                    >
                        ...
                        {user ? (
                            <div className="border border-emerald-500/30 bg-emerald-500/10 text-emerald-200 rounded-xl px-4 py-4 text-sm mb-2 flex flex-col gap-3">
                                ...
                                <Button variant="arcade" onClick={() => { onClose(); router.push("/profile"); }} className="w-full h-12">
                                    Continue to Profile
                                </Button>
                            </div>
                        ) : (
                            <div className="space-y-6 relative">
                                <div className="grid grid-cols-2 gap-2 rounded-xl border border-foreground/10 bg-black/30 p-1 mb-2">
                                    <Button
                                        type="button"
                                        variant={mode === "sign-in" ? "active" : "ghost"}
                                        className="h-10 text-xs font-bold uppercase tracking-widest rounded-lg"
                                ...
                                <Button variant="arcadeOutline" onClick={handleGoogle} className="w-full h-12 flex gap-3 text-sm shadow-none border-foreground/5 hover:border-foreground/10" disabled={!supabaseReady || isLoading || isSubmitting || cooldownSeconds > 0}>
